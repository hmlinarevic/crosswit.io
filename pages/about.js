    ...
    return (
        <section className="mx-auto w-[600px] font-roboto">
            ...
            <div className="pt-12">
                ...
                <p className="">
                    Crosswit is a game where you can exercise parts of your
                    brain responsible for short term memory.
                </p>
                <p className="mt-4 ">
                ...
                <h2 className="mt-12 mb-2 text-2xl text-neutral-500">
                    did you know?
                </h2>
                <p className="">
                ...
                <h2 className="mt-12 mb-6 text-2xl text-neutral-500">
                    how to play?
                </h2>
